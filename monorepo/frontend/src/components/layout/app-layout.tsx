        ...
        <Sidebar>
          ...
          <SidebarContent>
            <SidebarMenu>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild isActive={pathname === "/claims" || pathname.startsWith("/claims/")} tooltip="Claims">
                  <Link href="/claims">
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild isActive={pathname === "/policyholders" || pathname.startsWith("/policyholders/")} tooltip="Policyholders">
